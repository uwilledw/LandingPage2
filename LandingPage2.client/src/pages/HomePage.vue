<template>
  <div class="container-fluid">
    <section id="hero" class="row fade hero-img justify-content-center align-items-center">
    ...
    <section id="port" class="fade">
      <section class="row bg-greyish justify-content-center">
      ...
      <section class="row justify-content-center mt-5">
        <div class="col-md-8">
          <h4>These sites are being hosted using a free service, which may cause them to load slower than usual. I
            apologize
